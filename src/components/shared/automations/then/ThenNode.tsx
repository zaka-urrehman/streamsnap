...
import { PlaneBlue, PlaneCyan, SmartAi, Warning } from '@/icons'
import React from 'react'
import PostButton from '@/components/shared/automations/post/PostButton'
...
const ThenNode = ({ id }: Props) => {
    ...
    return !data?.data?.listener ? (
        ...
        <div className="w-full lg:w-10/12 relative xl:w-6/12 p-5 rounded-xl flex flex-col bg-gray-100 dark:bg-[#1D1D1D] gap-y-3">
